...
console.log(myPow(3, 4, myPrint)); // 3^4=81
console.log(myPow(2, 5, myPrint)); // 2^5=32
...
car2.used = 'new';
console.log(car2.info()); // Infinite FX50 AWD, 5000cc, year 2022, new -- изменения не выполняются
...
let notUniqNums = [1, 1, 2, 3, 4, 4, 5, 6, 7];
